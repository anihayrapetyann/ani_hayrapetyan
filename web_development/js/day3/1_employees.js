...
const newEmployeedata = JSON.parse(employeeData);
console.log(newEmployeedata);

// --------------------ex.1- creating a new array following model {name, position, salary}----------------------------
const newArray = newEmployeedata.map(obj => ({name:obj.name, position:obj.hr.position, salary:obj.hr.salary}));
